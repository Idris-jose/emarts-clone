...
<header className="w-full relative sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-200">
  <div className='flex items-center justify-between py-4 lg:py-6 mx-auto w-full max-w-[1366px] px-4 md:px-6 lg:px-8 2xl:px-10'>
    ...
    <div className='flex items-center gap-3 lg:gap-5'>
      ...
      <div className='relative flex items-center gap-2 cursor-pointer group ml-2'>
          ...
          <button onClick={() => setIsOpen(!isOpen)} className='text-sm font-medium text-gray-700 group-hover:text-black transition-colors hidden sm:block'>Sign In / Up</button>
